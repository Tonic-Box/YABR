...
/**
 * Demo showing bytecode pattern searches over classes in the pool.
 */
public class PatternSearchDemo
{

    /**
     * Loads the given class files and runs pattern searches against java/lang/String.
    ...
    public static void main(String[] args) throws Exception
    {
        ...
        List<SearchResult> equalsCall = search.findPattern(Patterns.methodCall("java/lang/String", "equals"));
        ...
        List<SearchResult> staticCalls = search.findPattern(Patterns.staticMethodCall());
