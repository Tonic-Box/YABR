...
/**
 * Demo showing dependency graph construction and queries over loaded classes.
 */
public class DependencyDemo
{

    /**
     * Analyzes dependencies of the given class files, or runs a synthetic demo when none are given.
    ...
    {
        ClassFile classA = ClassFactory.createClass(pool, "com/test/ClassA", 0x21);
        ClassFile classB = ClassFactory.createClass(pool, "com/test/ClassB", 0x21);
        ClassFile classC = ClassFactory.createClass(pool, "com/test/ClassC", 0x21);
