...
public class FullFrame extends StackMapFrame
{
     ...
     * @param classFile the class file positioned at the frame body, read from as a side effect
     * @param constPool the constant pool used to resolve object verification types
     */
