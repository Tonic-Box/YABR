...
public class MethodEntry extends MemberEntry
{
     ...
     * @param visitor the visitor to apply
     * @throws IOException if the visitor fails while reading the method
     */
    ...
    /**
     * @return true if the return type is a primitive (excluding void)
     */
    ...
    /**
     * @return true if the return type is a non-array reference type
     */
    ...
    /**
     * @return true if the return type is a one-dimensional primitive array
     */
    ...
    /**
     * @return true if the return type is an array with a reference element type
     */
