...
public class CodeWriter {
        ...
        while (true) {
            ...
            if (b instanceof GotoInstruction) {
                ...
                ConditionalBranchInstruction inverted =
                        new ConditionalBranchInstruction(InstructionLayout.invertConditionalOpcode(c.getType()), 0, (short) 0);
                GotoInstruction wide = new GotoInstruction(GOTO_W.getCode(), 0, 0);
    ...
    private Instruction rebuildBranch(Instruction i, int newOff, List<Instruction> targets,
        ...
        if (i instanceof TableSwitchInstruction) {
            ...
            return new TableSwitchInstruction(op, newOff, InstructionLayout.paddingAfterOpcode(newOff),
        ...
        return new LookupSwitchInstruction(op, newOff, InstructionLayout.paddingAfterOpcode(newOff),
