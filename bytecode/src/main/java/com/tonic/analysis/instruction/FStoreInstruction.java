 ...
 */
@Getter
public class FStoreInstruction extends Instruction implements LocalVarInstruction {
    ...
    private static boolean isShortForm(int opcode) {
        return opcode >= FSTORE_0.getCode() && opcode <= FSTORE_3.getCode();
    }
