 ...
 *
 * <p>Family classification delegates to {@link BootstrapFamilies}'s owner/name predicates so the JDK
...
public final class Bootstraps {
    ...
    public static final class BootstrapRef {
        ...
        public String category() {
            if (BootstrapFamilies.isStringConcat(owner)) {
                return "stringconcat";
            }
            if (BootstrapFamilies.isLambda(owner, name)) {
                return "lambda";
            }
            if (BootstrapFamilies.isSwitch(owner)) {
                return "switch";
            }
            if (BootstrapFamilies.isRecord(owner, name)) {
                return "record";
            }
            return "other";
        }
