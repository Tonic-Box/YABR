...
public final class ConditionParser
{
     ...
     * @param tokens the token list to read
     * @param start the index to begin parsing at
     */
     ...
     * @throws ParseException if the input is malformed or has trailing tokens
     */
    ...
    /**
     * Parses one condition from the current position, stopping at the first token the grammar
     * cannot continue with.
     * @return the parsed condition
     * @throws ParseException if the tokens do not form a valid condition
     */
