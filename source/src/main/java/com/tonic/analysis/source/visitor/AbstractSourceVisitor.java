...
/**
 * Base SourceVisitor whose visit methods walk the whole tree and return {@link #defaultValue()}.
 *
...
public abstract class AbstractSourceVisitor<T> implements SourceVisitor<T>
{
    ...
    /**
     * The value every visit method returns unless a subclass overrides it.
     *
     * @return null
     */
