...
public class ASTEditor
{
     ...
     *
     * @param methodBody       the block to edit
     * @param methodName       the enclosing method's name, exposed to handlers
     * @param methodDescriptor the enclosing method's descriptor, exposed to handlers
     * @param ownerClass       the internal name of the declaring class, exposed to handlers
     */
     ...
     * @param handler the handler to run on every call site
     * @return this editor
     */
     ...
     * @param handler the handler to run on every field access
     * @return this editor
     */
     ...
     * @param handler the handler to run on every allocation
     * @return this editor
     */
     ...
     * @param handler the handler to run on every array allocation
     * @return this editor
     */
     ...
     * @param handler the handler to run on every cast
     * @return this editor
     */
     ...
     * @param handler the handler to run on every instanceof test
     * @return this editor
     */
     ...
     * @param handler the handler to run on every binary expression
     * @return this editor
     */
     ...
     * @param handler the handler to run on every unary expression
     * @return this editor
     */
     ...
     * @param handler the handler to run on array accesses whose type is READ
     * @return this editor
     */
     ...
     * @param handler the handler to run on array accesses whose type is STORE
     * @return this editor
     */
     ...
     * @param handler the handler to run on every return
     * @return this editor
     */
     ...
     * @param handler the handler to run on every throw
     * @return this editor
     */
     ...
     * @param handler the handler to run on every if
     * @return this editor
     */
     ...
     * @param handler the handler to run on every loop
     * @return this editor
     */
     ...
     * @param handler the handler to run on every try-catch
     * @return this editor
     */
     ...
     * @param handler the handler to run on every assignment
     * @return this editor
     */
     ...
     * @param matcher selects which expressions the handler sees
     ...
     * @param matcher selects which statements the handler sees
     * @param handler the handler to run on each match
     * @return this editor
     */
     ...
     * @return the method body, edited in place
     */
     ...
     * @param matcher the predicate expressions are tested against
     * @return the matching expressions in traversal order
     */
