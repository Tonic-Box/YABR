...
public class MethodRenamer
{
    ...
    /**
     * @param context mappings and class pool the renames are applied against
     */
    ...
    private void renameMethodSingle(MethodMapping mapping)
    {
        ...
        Set<String> refOwners = expandToInheritingOwners(Set.of(currentOwner), mapping.getOldName(), currentDescriptor);
