 ...
 * <ul>
 *   <li>{@code FAILED} - decompiling threw. A defect, always.</li>
 *   <li>{@code SKIPPED} - decompiled, but re-lowering could not take the source back. Also a defect, but a
 *       narrower one: the recompile gates cannot grade this class, so it is invisible to them.</li>
 *   <li>{@code DRIFTS} - re-lowered, but decompiling the result gives different text. Not a fixed point.</li>
 *   <li>{@code GRADED} - round-trips to identical source. What every class should be.</li>
 * </ul>
