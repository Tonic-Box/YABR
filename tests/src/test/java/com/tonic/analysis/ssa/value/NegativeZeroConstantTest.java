...
class NegativeZeroConstantTest
{
    ...
    void doubleNegativeZeroKeepsItsSign()
    {
        ...
        assertEquals(Double.doubleToRawLongBits(-0.0), Double.doubleToRawLongBits(DoubleConstant.of(-0.0).getValue()));
    }
    ...
    void floatNegativeZeroKeepsItsSign()
    {
        ...
        assertEquals(Float.floatToRawIntBits(-0.0f), Float.floatToRawIntBits(FloatConstant.of(-0.0f).getValue()));
    }
}
