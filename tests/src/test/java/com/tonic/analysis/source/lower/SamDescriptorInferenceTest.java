...
class SamDescriptorInferenceTest
{
    ...
    class InferSamDescriptorFromMethodRefTests
    {
        ...
        {
            MethodRefExpr ref = MethodRefExpr.staticRef("java/lang/Integer", "parseInt", funcInterface("Function"));
        ...
        {
            MethodRefExpr ref = MethodRefExpr.staticRef("java/lang/String", "valueOf", funcInterface("IntFunction"));
        ...
        {
            MethodRefExpr ref = MethodRefExpr.instanceRef("java/lang/String", "length", funcInterface("ToIntFunction"));
        ...
        {
            MethodRefExpr ref = MethodRefExpr.instanceRef("java/io/PrintStream", "println", funcInterface("Consumer"));
        ...
        {
            MethodRefExpr ref = MethodRefExpr.instanceRef("java/lang/String", "isEmpty", funcInterface("Predicate"));
        ...
        {
            MethodRefExpr ref = MethodRefExpr.constructorRef("java/util/ArrayList", funcInterface("Supplier"));
