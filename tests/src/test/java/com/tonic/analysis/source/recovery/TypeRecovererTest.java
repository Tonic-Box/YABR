...
class TypeRecovererTest
{
    ...
    class ComputeCommonTypeTests
    {
        ...
        {
            Collection<SourceType> types = Arrays.asList(VoidSourceType.INSTANCE, VoidSourceType.INSTANCE);
            SourceType result = recoverer.computeCommonType(types);
            assertEquals(VoidSourceType.INSTANCE, result);
        }
        ...
        {
            Collection<SourceType> types = Arrays.asList(PrimitiveSourceType.LONG, null, PrimitiveSourceType.LONG);
            SourceType result = recoverer.computeCommonType(types);
            assertEquals(PrimitiveSourceType.LONG, result);
        }
        ...
        {
            Collection<SourceType> types = Arrays.asList(PrimitiveSourceType.BYTE, PrimitiveSourceType.SHORT);
            SourceType result = recoverer.computeCommonType(types);
            assertEquals(PrimitiveSourceType.SHORT, result);
        }
        ...
        {
            Collection<SourceType> types = Arrays.asList(PrimitiveSourceType.BYTE, PrimitiveSourceType.INT);
            SourceType result = recoverer.computeCommonType(types);
            assertEquals(PrimitiveSourceType.INT, result);
        }
        ...
        {
            Collection<SourceType> types = Arrays.asList(PrimitiveSourceType.INT, PrimitiveSourceType.LONG);
            SourceType result = recoverer.computeCommonType(types);
            assertEquals(PrimitiveSourceType.LONG, result);
        }
        ...
        {
            Collection<SourceType> types = Arrays.asList(PrimitiveSourceType.LONG, PrimitiveSourceType.FLOAT);
            SourceType result = recoverer.computeCommonType(types);
            assertEquals(PrimitiveSourceType.FLOAT, result);
        }
        ...
        {
            Collection<SourceType> types = Arrays.asList(PrimitiveSourceType.FLOAT, PrimitiveSourceType.DOUBLE);
            SourceType result = recoverer.computeCommonType(types);
            assertEquals(PrimitiveSourceType.DOUBLE, result);
        }
        ...
        {
            Collection<SourceType> types = Arrays.asList(PrimitiveSourceType.INT, PrimitiveSourceType.DOUBLE);
            SourceType result = recoverer.computeCommonType(types);
            assertEquals(PrimitiveSourceType.DOUBLE, result);
        }
        ...
        {
            Collection<SourceType> types = Arrays.asList(PrimitiveSourceType.CHAR, PrimitiveSourceType.INT);
            SourceType result = recoverer.computeCommonType(types);
            assertEquals(PrimitiveSourceType.INT, result);
        }
        ...
        void computeCommonType_booleanAndInt_returnsInt()
        {
            ...
            Collection<SourceType> types = Arrays.asList(PrimitiveSourceType.BOOLEAN, PrimitiveSourceType.INT);
            SourceType result = recoverer.computeCommonType(types);
            assertEquals(PrimitiveSourceType.INT, result);
        }
        ...
        {
            Collection<SourceType> types = Arrays.asList(PrimitiveSourceType.BOOLEAN, PrimitiveSourceType.BOOLEAN);
            SourceType result = recoverer.computeCommonType(types);
            assertEquals(PrimitiveSourceType.BOOLEAN, result);
        }
