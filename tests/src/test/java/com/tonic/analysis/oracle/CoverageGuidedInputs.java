...
final class CoverageGuidedInputs
{
     ...
     */
    static List<InputSpec> generate(String descriptor, long[] dict, long seed, int seedCount, int corpusCap, int probeBudget, Function<InputSpec, Set<String>> probe)
    {
    ...
    private static void explore(InputSpec parent, List<String> params, long[] dict, List<InputSpec> corpus, Deque<InputSpec> queue, Set<String> covered, Function<InputSpec, Set<String>> probe, int corpusCap, int probeBudget, int[] runs)
    {
