...
class ExceptionHandlerExecutionTest
{
    ...
    class BasicHandlerTests
    {
        ...
        void testSimpleTryCatch()
        {
            ...
            assertEquals(-1, result.getReturnValue().asInt(), "Caught exception should result in return value -1");
            assertNull(result.getException(), "Exception should not propagate when caught");
        }
        ...
        void testTryCatchMiss()
        {
            ...
            assertEquals(BytecodeResult.Status.EXCEPTION, result.getStatus(), "Uncaught exception should propagate");
            assertNotNull(result.getException(), "Exception object should be present");
        ...
        void testCatchAllHandler()
        {
            ...
            assertNotNull(result.getReturnValue(), "Should have a return value");
        }
        ...
        void testMultipleHandlers()
        {
            ...
            assertNotNull(result.getReturnValue(), "Should return value after handling exception");
        }
    ...
    class TypeHierarchyTests
    {
        ...
        void testCatchSupertype()
        {
            ...
            BytecodeResult result = engine.execute(method, ConcreteValue.intValue(100), ConcreteValue.intValue(0));

            assertEquals(BytecodeResult.Status.COMPLETED, result.getStatus(),
                "Supertype handler should catch subtype exception");
            assertEquals(-1, result.getReturnValue().asInt(), "Handler for supertype should execute");
        }
        ...
        void testCatchExactType()
        {
            ...
            assertEquals(BytecodeResult.Status.COMPLETED, result.getStatus(), "Exact type match should be caught");
            assertEquals(-1, result.getReturnValue().asInt(), "Exact match handler should execute");
        }
        ...
        void testSubtypeNotCaught()
        {
            ...
            BytecodeResult result = engine.execute(method, ConcreteValue.intValue(10), ConcreteValue.intValue(5));
        ...
        void testCatchThrowable()
        {
            ...
            BytecodeResult result = engine.execute(method, ConcreteValue.intValue(20), ConcreteValue.intValue(0));

            assertEquals(BytecodeResult.Status.COMPLETED, result.getStatus(),
                "Throwable handler should catch all exceptions");
            assertEquals(-1, result.getReturnValue().asInt(), "Throwable catch should execute handler");
        }
    }
    ...
    class StackBehaviorTests
    {
        ...
        void testStackClearedOnCatch()
        {
            ...
            assertNotNull(result.getReturnValue(), "Cleared stack should not affect return value");
        }
        ...
        void testExceptionOnStack()
        {
            ...
            assertEquals(-1, result.getReturnValue().asInt(), "Handler can access exception from stack");
        }
        ...
        void testStackDepthAfterCatch()
        {
            ...
            BytecodeResult result = engine.execute(method, ConcreteValue.intValue(15), ConcreteValue.intValue(0));

            assertEquals(BytecodeResult.Status.COMPLETED, result.getStatus(),
                "Stack should have correct depth in handler");
            assertEquals(-1, result.getReturnValue().asInt(), "Handler executes with properly initialized stack");
        }
    }
    ...
    class ControlFlowTests
    {
        ...
        void testHandlerPcJump()
        {
            ...
            assertEquals(BytecodeResult.Status.COMPLETED, result.getStatus(), "PC should jump to handler correctly");
            assertEquals(-1, result.getReturnValue().asInt(), "Handler code should execute at correct PC");
        }
        ...
        void testExecutionContinuesAfterCatch()
        {
            ...
            assertEquals(5, result.getReturnValue().asInt(), "Normal path should execute correctly");
        }
        ...
        void testRethrowFromHandler()
        {
            ...
            assertNotNull(result.getReturnValue(), "Rethrowing handler should still allow completion");
        }
        ...
        void testThrowDifferentFromHandler()
        {
            ...
            assertNotNull(result.getReturnValue(), "Different exception handled correctly");
        }
    }
    ...
    class CrossMethodTests
    {
        ...
        void testExceptionPropagatesAcrossMethods()
        {
            ...
            assertEquals(-1, result.getReturnValue().asInt(), "Caller handler should catch callee exception");
        }
        ...
        void testNestedCallsWithHandlers()
        {
            ...
            assertEquals(BytecodeResult.Status.COMPLETED, result.getStatus(), "Nested handlers should work correctly");
            assertNotNull(result.getReturnValue(), "Nested exception handling preserves return values");
        }
        ...
        void testExceptionFromCaller()
        {
            ...
            assertEquals(-1, result.getReturnValue().asInt(), "Caller exception handler should execute");
        }
    }
    ...
    class EdgeCaseTests
    {
        ...
        void testNullExceptionThrow()
        {
            ...
            assertEquals(5, result.getReturnValue().asInt(), "Normal division should work correctly");
        }
        ...
        void testEmptyExceptionTable()
        {
            ...
            assertNotNull(result.getException(), "Exception object should be available");
        }
        ...
        void testOverlappingHandlerRanges()
        {
            ...
            assertNotNull(result.getReturnValue(), "Overlapping handlers should not interfere");
        }
    ...
    class RecursiveExceptionTests
    {
        ...
        void testRecursiveCallWithinLimit()
        {
            ...
            assertEquals(BytecodeResult.Status.COMPLETED, result.getStatus(), "Should complete normally within limit");
            assertEquals(15, result.getReturnValue().asInt(), "Should calculate correct sum");
        }
        ...
        void testSafeRecursiveWithCatch()
        {
            ...
            BytecodeResult result = engine.execute(method, ConcreteValue.intValue(20), ConcreteValue.intValue(10));

            assertEquals(BytecodeResult.Status.COMPLETED, result.getStatus(),
                "Should catch exception from recursive call");
            assertEquals(-1, result.getReturnValue().asInt(), "Should return -1 when exception caught");
        }
    ...
    class FinallyBlockTests
    {
        ...
        void testFinallyExecutes()
        {
            ...
            assertEquals(BytecodeResult.Status.COMPLETED, result.getStatus(), "Finally should allow normal completion");
            assertEquals(20, result.getReturnValue().asInt(), "Finally block should execute");
        }
        ...
        void testFinallyExecutesWithException()
        {
            ...
            BytecodeResult result = engine.execute(method, ConcreteValue.intValue(3));

            assertEquals(BytecodeResult.Status.COMPLETED, result.getStatus(),
                "Finally should execute regardless of exception");
            assertEquals(6, result.getReturnValue().asInt(), "Finally modifies value correctly");
        }
        ...
        void testFinallyDoesNotInterfereWithReturn()
        {
            ...
            assertEquals(14, result.getReturnValue().asInt(), "Return value correctly computed");
        }
    }
    ...
    class ExceptionStackTraceTests
    {
        ...
        void testStackTraceOnException()
        {
            ...
            assertEquals(BytecodeResult.Status.EXCEPTION, result.getStatus(), "Should throw exception");
            assertNotNull(result.getStackTrace(), "Stack trace should be present (may be empty)");
        }
        ...
        void testStackTraceAvailable()
        {
            ...
            assertEquals(BytecodeResult.Status.EXCEPTION, result.getStatus());
            assertNotNull(result.getStackTrace(), "Stack trace list should not be null");
        }
