...
class NativeRegistryTest {
    ...
    void testMathMaxLong() throws NativeException {
        ...
        ConcreteValue result = registry.execute(
            createTestMethod("java/lang/Math", "max", "(JJ)J", 0x0109),
            null,
            new ConcreteValue[] { ConcreteValue.longValue(10L), ConcreteValue.longValue(20L) },
            context
        );
    ...
    void testMathMaxDouble() throws NativeException {
        ...
        ConcreteValue result = registry.execute(
            createTestMethod("java/lang/Math", "max", "(DD)D", 0x0109),
            null,
            new ConcreteValue[] { ConcreteValue.doubleValue(10.0), ConcreteValue.doubleValue(20.0) },
            context
        );

        assertEquals(20.0, result.asDouble(), 0.0001);
    }
    ...
    void testMathMinLong() throws NativeException {
        ...
        ConcreteValue result = registry.execute(
            createTestMethod("java/lang/Math", "min", "(JJ)J", 0x0109),
            null,
            new ConcreteValue[] { ConcreteValue.longValue(10L), ConcreteValue.longValue(20L) },
            context
        );
    ...
    void testMathMinDouble() throws NativeException {
        ...
        ConcreteValue result = registry.execute(
            createTestMethod("java/lang/Math", "min", "(DD)D", 0x0109),
            null,
            new ConcreteValue[] { ConcreteValue.doubleValue(10.0), ConcreteValue.doubleValue(20.0) },
            context
        );

        assertEquals(10.0, result.asDouble(), 0.0001);
    }
