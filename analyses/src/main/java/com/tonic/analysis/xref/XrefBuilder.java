...
public class XrefBuilder
{
     ...
     * @param classPool the pool whose classes are scanned
     */
    ...
    /**
     * @return the database being built, readable before the scan completes
     */
     ...
     * @param callback the progress sink, or null to disable reporting
     */
     ...
     */
    private void processInstruction(ClassFile cf, IRInstruction instr, String sourceClass, String sourceMethod, String sourceMethodDesc, int instrIndex, int bytecodeOffset)
    {
     ...
     */
    private void processConstantForXref(ClassFile cf, Constant constant, String sourceClass, String sourceMethod, String sourceMethodDesc, int instrIndex, int bytecodeOffset)
    {
     ...
     */
    private void processBootstrapInfo(ClassFile cf, BootstrapMethodInfo bootstrapInfo, String sourceClass, String sourceMethod, String sourceMethodDesc, int instrIndex, int bytecodeOffset)
    {
     ...
     */
    private void processMethodHandleConstant(MethodHandleConstant mh, String sourceClass, String sourceMethod, String sourceMethodDesc, int instrIndex, int bytecodeOffset, XrefType xrefType)
    {
     ...
     */
    private void processBootstrapMethodFromCP(ClassFile cf, BootstrapMethod bsm, String sourceClass, String sourceMethod, String sourceMethodDesc, int instrIndex, int bytecodeOffset)
    {
        try
        {
     ...
     */
    private void processMethodHandleFromCP(ClassFile cf, MethodHandleItem mhItem, String sourceClass, String sourceMethod, String sourceMethodDesc, int instrIndex, int bytecodeOffset, XrefType xrefType)
    {
        try
        {
     ...
     */
    private void processNestedCondy(ClassFile cf, ConstantDynamicItem condy, String sourceClass, String sourceMethod, String sourceMethodDesc, int instrIndex, int bytecodeOffset)
    {
        try
        {
            BootstrapMethodsAttribute bsmAttr = findBootstrapMethodsAttribute(cf);
