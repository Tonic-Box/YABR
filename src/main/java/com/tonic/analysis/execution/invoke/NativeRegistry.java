...
public final class NativeRegistry {
    ...
    private void registerJdkCoreHandlers() {
        ...
        register("jdk/internal/misc/Unsafe", "isBigEndian0", "()Z",
            (receiver, args, ctx) -> ConcreteValue.intValue(0));

        register("jdk/internal/misc/Unsafe", "unalignedAccess0", "()Z",
            (receiver, args, ctx) -> ConcreteValue.intValue(1));

        register("jdk/internal/misc/Unsafe", "storeFence", "()V",
            (receiver, args, ctx) -> null);

        register("jdk/internal/misc/Unsafe", "loadFence", "()V",
            (receiver, args, ctx) -> null);

        register("jdk/internal/misc/Unsafe", "fullFence", "()V",
            (receiver, args, ctx) -> null);

        register("jdk/internal/misc/Unsafe", "ensureClassInitialized0", "(Ljava/lang/Class;)V",
            (receiver, args, ctx) -> null);

        register("jdk/internal/misc/Unsafe", "shouldBeInitialized0", "(Ljava/lang/Class;)Z",
            (receiver, args, ctx) -> ConcreteValue.intValue(0));

        register("jdk/internal/misc/Unsafe", "getInt", "(Ljava/lang/Object;J)I",
            (receiver, args, ctx) -> ConcreteValue.intValue(0));

        register("jdk/internal/misc/Unsafe", "getLong", "(Ljava/lang/Object;J)J",
            (receiver, args, ctx) -> ConcreteValue.longValue(0L));

        register("jdk/internal/misc/Unsafe", "getObject", "(Ljava/lang/Object;J)Ljava/lang/Object;",
            (receiver, args, ctx) -> ConcreteValue.nullRef());

        register("jdk/internal/misc/Unsafe", "getReference", "(Ljava/lang/Object;J)Ljava/lang/Object;",
            (receiver, args, ctx) -> ConcreteValue.nullRef());

        register("jdk/internal/misc/Unsafe", "getByte", "(Ljava/lang/Object;J)B",
            (receiver, args, ctx) -> ConcreteValue.intValue(0));

        register("jdk/internal/misc/Unsafe", "getShort", "(Ljava/lang/Object;J)S",
            (receiver, args, ctx) -> ConcreteValue.intValue(0));

        register("jdk/internal/misc/Unsafe", "getChar", "(Ljava/lang/Object;J)C",
            (receiver, args, ctx) -> ConcreteValue.intValue(0));

        register("jdk/internal/misc/Unsafe", "getFloat", "(Ljava/lang/Object;J)F",
            (receiver, args, ctx) -> ConcreteValue.floatValue(0.0f));

        register("jdk/internal/misc/Unsafe", "getDouble", "(Ljava/lang/Object;J)D",
            (receiver, args, ctx) -> ConcreteValue.doubleValue(0.0));

        register("jdk/internal/misc/Unsafe", "getBoolean", "(Ljava/lang/Object;J)Z",
            (receiver, args, ctx) -> ConcreteValue.intValue(0));

        register("jdk/internal/misc/Unsafe", "putInt", "(Ljava/lang/Object;JI)V",
            (receiver, args, ctx) -> null);

        register("jdk/internal/misc/Unsafe", "putLong", "(Ljava/lang/Object;JJ)V",
            (receiver, args, ctx) -> null);

        register("jdk/internal/misc/Unsafe", "putObject", "(Ljava/lang/Object;JLjava/lang/Object;)V",
            (receiver, args, ctx) -> null);

        register("jdk/internal/misc/Unsafe", "putReference", "(Ljava/lang/Object;JLjava/lang/Object;)V",
            (receiver, args, ctx) -> null);

        register("jdk/internal/misc/Unsafe", "putByte", "(Ljava/lang/Object;JB)V",
            (receiver, args, ctx) -> null);

        register("jdk/internal/misc/Unsafe", "putShort", "(Ljava/lang/Object;JS)V",
            (receiver, args, ctx) -> null);

        register("jdk/internal/misc/Unsafe", "putChar", "(Ljava/lang/Object;JC)V",
            (receiver, args, ctx) -> null);

        register("jdk/internal/misc/Unsafe", "putFloat", "(Ljava/lang/Object;JF)V",
            (receiver, args, ctx) -> null);

        register("jdk/internal/misc/Unsafe", "putDouble", "(Ljava/lang/Object;JD)V",
            (receiver, args, ctx) -> null);

        register("jdk/internal/misc/Unsafe", "putBoolean", "(Ljava/lang/Object;JZ)V",
            (receiver, args, ctx) -> null);

        register("jdk/internal/misc/Unsafe", "allocateMemory0", "(J)J",
            (receiver, args, ctx) -> ConcreteValue.longValue(0L));

        register("jdk/internal/misc/Unsafe", "freeMemory0", "(J)V",
            (receiver, args, ctx) -> null);

        register("jdk/internal/misc/Unsafe", "setMemory0", "(Ljava/lang/Object;JJB)V",
            (receiver, args, ctx) -> null);

        register("jdk/internal/misc/Unsafe", "copyMemory0", "(Ljava/lang/Object;JLjava/lang/Object;JJ)V",
            (receiver, args, ctx) -> null);

        register("jdk/internal/misc/Unsafe", "getLoadAverage0", "([DI)I",
            (receiver, args, ctx) -> ConcreteValue.intValue(0));

        register("jdk/internal/misc/Unsafe", "park", "(ZJ)V",
            (receiver, args, ctx) -> null);

        register("jdk/internal/misc/Unsafe", "unpark", "(Ljava/lang/Object;)V",
            (receiver, args, ctx) -> null);

        registerMoreSystemHandlers();
    }

    private void registerMoreSystemHandlers() {
        register("java/lang/System", "currentTimeMillis", "()J",
            (receiver, args, ctx) -> ConcreteValue.longValue(System.currentTimeMillis()));
        ...
        register("java/lang/Object", "notifyAll", "()V",
            (receiver, args, ctx) -> null);

        register("java/lang/Object", "notify", "()V",
            (receiver, args, ctx) -> null);

        register("java/lang/Object", "wait", "(J)V",
            (receiver, args, ctx) -> null);
        ...
        register("java/lang/Math", "floor", "(D)D",
            (receiver, args, ctx) -> ConcreteValue.doubleValue(
                Math.floor(args != null && args.length > 0 ? args[0].asDouble() : 0.0)));

        register("java/lang/Math", "ceil", "(D)D",
            (receiver, args, ctx) -> ConcreteValue.doubleValue(
                Math.ceil(args != null && args.length > 0 ? args[0].asDouble() : 0.0)));

        register("java/lang/Math", "rint", "(D)D",
            (receiver, args, ctx) -> ConcreteValue.doubleValue(
                Math.rint(args != null && args.length > 0 ? args[0].asDouble() : 0.0)));

        register("java/lang/Thread", "sleep", "(J)V",
            (receiver, args, ctx) -> null);

        register("java/lang/Thread", "yield", "()V",
            (receiver, args, ctx) -> null);

        register("java/lang/Thread", "interrupt0", "()V",
            (receiver, args, ctx) -> null);

        register("java/lang/Thread", "isInterrupted", "(Z)Z",
            (receiver, args, ctx) -> ConcreteValue.intValue(0));
        ...
        register("java/lang/Thread", "setPriority0", "(I)V",
            (receiver, args, ctx) -> null);

        register("java/lang/Thread", "holdsLock", "(Ljava/lang/Object;)Z",
            (receiver, args, ctx) -> ConcreteValue.intValue(0));

        register("java/lang/Throwable", "fillInStackTrace", "(I)Ljava/lang/Throwable;",
            (receiver, args, ctx) -> ConcreteValue.reference(receiver));

        register("java/lang/Throwable", "getStackTraceDepth", "()I",
            (receiver, args, ctx) -> ConcreteValue.intValue(0));

        register("java/lang/Throwable", "getStackTraceElement", "(I)Ljava/lang/StackTraceElement;",
            (receiver, args, ctx) -> {
                ObjectInstance ste = ctx.getHeapManager().newObject("java/lang/StackTraceElement");
                return ConcreteValue.reference(ste);
            });

        register("java/lang/reflect/Array", "newArray", "(Ljava/lang/Class;I)Ljava/lang/Object;",
            (receiver, args, ctx) -> {
        ...
        register("java/lang/reflect/Array", "getLength", "(Ljava/lang/Object;)I",
            (receiver, args, ctx) -> {
                if (args == null || args.length == 0 || args[0].isNull()) {
                    return ConcreteValue.intValue(0);
                }
        ...
        register("java/security/AccessController", "doPrivileged", "(Ljava/security/PrivilegedExceptionAction;)Ljava/lang/Object;",
            (receiver, args, ctx) -> ConcreteValue.nullRef());

        register("java/security/AccessController", "getStackAccessControlContext", "()Ljava/security/AccessControlContext;",
            (receiver, args, ctx) -> ConcreteValue.nullRef());

        register("jdk/internal/reflect/Reflection", "getCallerClass", "()Ljava/lang/Class;",
            (receiver, args, ctx) -> {
                ObjectInstance classObj = ctx.getHeapManager().newObject("java/lang/Class");
                return ConcreteValue.reference(classObj);
            });

        register("jdk/internal/reflect/Reflection", "getClassAccessFlags", "(Ljava/lang/Class;)I",
            (receiver, args, ctx) -> ConcreteValue.intValue(1));

        register("java/io/FileDescriptor", "initIDs", "()V",
            (receiver, args, ctx) -> null);

        register("java/io/FileInputStream", "initIDs", "()V",
            (receiver, args, ctx) -> null);

        register("java/io/FileOutputStream", "initIDs", "()V",
            (receiver, args, ctx) -> null);
