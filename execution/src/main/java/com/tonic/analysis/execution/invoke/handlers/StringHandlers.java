...
public final class StringHandlers implements NativeHandlerProvider
{
    ...
    private void registerStringHandlers(NativeRegistry registry)
    {
        registry.register("java/lang/String", "length", "()I",
            (receiver, args, ctx) -> {
                if (receiver == null)
                {
                    throw new NativeException("java/lang/NullPointerException", "length() on null String");
                }
        ...
        registry.register("java/lang/String", "charAt", "(I)C",
            (receiver, args, ctx) -> {
                if (receiver == null)
                {
                    throw new NativeException("java/lang/NullPointerException", "charAt() on null String");
                }
                String str = ctx.getHeapManager().extractString(receiver);
                if (str == null)
                {
                    throw new NativeException("java/lang/IllegalStateException", "Cannot extract string");
                }
                int index = args[0].asInt();
                if (index < 0 || index >= str.length())
                {
                    throw new NativeException("java/lang/StringIndexOutOfBoundsException", "Index: " + index);
                }
        ...
        registry.register("java/lang/String", "intern", "()Ljava/lang/String;",
            (receiver, args, ctx) -> {
                if (receiver == null)
                {
                    throw new NativeException("java/lang/NullPointerException", "intern() on null String");
                }
    ...
    private void registerStringInternalHandlers(NativeRegistry registry)
    {
        ...
        registry.register("java/lang/StringCoding", "err", "(Ljava/lang/String;)V", (receiver, args, ctx) -> null);
