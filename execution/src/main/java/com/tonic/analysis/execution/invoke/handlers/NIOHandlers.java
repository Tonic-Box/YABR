...
public final class NIOHandlers implements NativeHandlerProvider
{
    ...
    private void registerMappedByteBufferHandlers(NativeRegistry registry)
    {
        ...
        registry.register("java/nio/MappedByteBuffer", "load0", "(JJ)V", (receiver, args, ctx) -> null);
    ...
    {
        registry.register("sun/nio/ch/IOUtil", "initIDs", "()V", (receiver, args, ctx) -> null);

        registry.register("sun/nio/ch/IOUtil", "iovMax", "()I", (receiver, args, ctx) -> ConcreteValue.intValue(16));

        registry.register("sun/nio/ch/IOUtil", "fdLimit", "()I", (receiver, args, ctx) -> ConcreteValue.intValue(1024));
        ...
        registry.register("sun/nio/ch/IOUtil", "drain", "(I)Z", (receiver, args, ctx) -> ConcreteValue.intValue(1));

        registry.register("sun/nio/ch/IOUtil", "drain1", "(I)I", (receiver, args, ctx) -> ConcreteValue.intValue(0));

        registry.register("sun/nio/ch/IOUtil", "write1", "(IB)I", (receiver, args, ctx) -> ConcreteValue.intValue(1));
        ...
        registry.register("sun/nio/ch/FileKey", "initIDs", "()V", (receiver, args, ctx) -> null);

        registry.register("sun/nio/ch/FileKey", "init", "(Ljava/io/FileDescriptor;)V", (receiver, args, ctx) -> null);
    }

    private void registerNetHandlers(NativeRegistry registry)
    {
        registry.register("sun/nio/ch/Net", "initIDs", "()V", (receiver, args, ctx) -> null);
        ...
        registry.register("sun/nio/ch/Net", "socket0", "(ZZZZ)I", (receiver, args, ctx) -> ConcreteValue.intValue(-1));

        registry.register("sun/nio/ch/Net", "bind0", "(Ljava/io/FileDescriptor;ZZLjava/net/InetAddress;I)V",
            (receiver, args, ctx) -> null);

        registry.register("sun/nio/ch/Net", "listen", "(Ljava/io/FileDescriptor;I)V", (receiver, args, ctx) -> null);

        registry.register("sun/nio/ch/Net", "connect0", "(ZLjava/io/FileDescriptor;Ljava/net/InetAddress;I)I",
            (receiver, args, ctx) -> ConcreteValue.intValue(-1));

        registry.register("sun/nio/ch/Net", "shutdown", "(Ljava/io/FileDescriptor;I)V", (receiver, args, ctx) -> null);
        ...
        registry.register("sun/nio/ch/Net", "pollinValue", "()S", (receiver, args, ctx) -> ConcreteValue.intValue(1));

        registry.register("sun/nio/ch/Net", "polloutValue", "()S", (receiver, args, ctx) -> ConcreteValue.intValue(4));

        registry.register("sun/nio/ch/Net", "pollerrValue", "()S", (receiver, args, ctx) -> ConcreteValue.intValue(8));

        registry.register("sun/nio/ch/Net", "pollhupValue", "()S", (receiver, args, ctx) -> ConcreteValue.intValue(16));

        registry.register("sun/nio/ch/Net", "pollnvalValue", "()S",
            (receiver, args, ctx) -> ConcreteValue.intValue(32));

        registry.register("sun/nio/ch/Net", "pollconnValue", "()S", (receiver, args, ctx) -> ConcreteValue.intValue(2));
    }

    private void registerDatagramChannelHandlers(NativeRegistry registry)
    {
        registry.register("sun/nio/ch/DatagramChannelImpl", "initIDs", "()V", (receiver, args, ctx) -> null);
    ...
    {
        registry.register("sun/nio/ch/ServerSocketChannelImpl", "initIDs", "()V", (receiver, args, ctx) -> null);
    ...
    {
        registry.register("sun/nio/ch/Iocp", "initIDs", "()V", (receiver, args, ctx) -> null);

        registry.register("sun/nio/ch/Iocp", "createIoCompletionPort", "(JJII)J",
            (receiver, args, ctx) -> ConcreteValue.longValue(0L));

        registry.register("sun/nio/ch/Iocp", "close0", "(J)V", (receiver, args, ctx) -> null);

        registry.register("sun/nio/ch/Iocp", "getQueuedCompletionStatus", "(JLsun/nio/ch/Iocp$CompletionStatus;)V",
            (receiver, args, ctx) -> null);

        registry.register("sun/nio/ch/Iocp", "postQueuedCompletionStatus", "(JI)V", (receiver, args, ctx) -> null);
    ...
    private void registerWindowsSelectorHandlers(NativeRegistry registry)
    {
        ...
        registry.register("sun/nio/ch/WindowsSelectorImpl", "setWakeupSocket0", "(I)V", (receiver, args, ctx) -> null);
