...
public class FieldFilter implements InstrumentationFilter
{
     ...
     *
     * @param pattern the field name pattern, where '*' matches any run of characters
     * @return a filter constrained to names matching the pattern
     */
     ...
     *
     * @param typeDescriptor the field descriptor pattern, where '*' matches any run of characters
     * @return a filter constrained to that descriptor
     */
     ...
     *
     * @param ownerClass the owner pattern, where '*' matches any run of characters
     * @return a filter constrained to that owner
     */
     ...
     *
     * @param owner the owner pattern
     * @param name the field name pattern
     * @return a filter constrained to that owner and name
     */
