...
public class StackMapVerifier
{
     ...
     * @param classFile the class whose methods will be checked
     */
    ...
    /**
     * Checks that every branch target has a StackMapTable frame and that declared frames match
     * the computed type states.
