...
public class ExceptionTableVerifier
{
     ...
     * @param classFile the class whose constant pool resolves catch types
     */
    ...
    /**
     * Checks each exception-table entry's ranges, handler target, catch type, and overlap with
     * other handlers.
    ...
    private void verifyExceptionHandler(ExceptionTableEntry entry, int index, byte[] bytecode, Set<Integer> boundaries, ErrorCollector collector)
    {
